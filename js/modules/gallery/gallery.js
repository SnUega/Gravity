...
export class Gallery {
  ...
  createSlide(url, hidden = false) {
    ...
    const isPlaceholder = url.includes('img-placeholder');
    
    if (isPlaceholder) {
      // Render styled placeholder instead of broken/generic image
      slide.style.background = 'linear-gradient(135deg, #1e1e24 0%, #2a2a32 50%, #1e1e24 100%)';
      slide.innerHTML = `
        <div class="slide-coming-soon">
          <div class="slide-coming-soon__circle"></div>
          <div class="slide-coming-soon__inner">
